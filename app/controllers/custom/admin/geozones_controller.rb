class Admin::GeozonesController < Admin::BaseController
  ...
  def create
    ...
    if @geozone.save
      redirect_to admin_geozones_path, notice: t("admin.geozones.geozone.create.notice")
    else
      render :new
    end
  end
  ...
  def update
    if @geozone.update(geozone_params)
      redirect_to admin_geozones_path, notice: t("admin.geozones.geozone.update.notice")
    else
      render :edit
    end
  end
