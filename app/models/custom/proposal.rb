class Proposal < ApplicationRecord
  ...
  def voted_yes_by_current_user(user)
    # Assuming current_user is the method or variable holding the current user
    votes = find_votes_for(voter: user)
    votes.exists?(vote_flag: true)
  end
